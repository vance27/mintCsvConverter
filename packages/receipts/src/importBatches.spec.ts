...
async function seedTransaction(prisma: PrismaClient, importBatchId: number, description: string, syncedAt: Date | null) {
  return prisma.importedTransaction.create({
    data: { payer: 'Brian', date: '06/20/2026', description, amount: 10, splitType: 'Equally', importBatchId, syncedAt },
  });
}
