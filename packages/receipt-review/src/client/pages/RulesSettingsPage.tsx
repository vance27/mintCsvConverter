...
export function RulesSettingsPage() {
    ...
    function toggleAllExclusionSelected(): void {
        ...
        setSelectedExclusionIds((prev) =>
            prev.size === exclusionRules.length ? new Set() : new Set(exclusionRules.map((r) => r.id)),
        );
    }
    ...
    async function handleDeleteSelectedVariableRules(): Promise<void> {
        setError(null);
        await Promise.all(
            [...selectedVariableIds].map((id) =>
                api['variable-split-rules'][':id'].$delete({ param: { id: String(id) } }),
            ),
        );
    ...
    function toggleAllVariableSelected(): void {
        ...
        setSelectedVariableIds((prev) =>
            prev.size === variableRules.length ? new Set() : new Set(variableRules.map((r) => r.id)),
        );
    }
            ...
            <Stack spacing={3}>
                ...
                <Paper sx={{ p: 3 }}>
                    <Stack spacing={2}>
                        ...
                        <Typography color="text.secondary">
                            Transactions whose description contains one of these substrings (case-insensitive) are
                            excluded entirely for that payer — personal spending, not split with anyone.
                        </Typography>
                                                ...
                                                <TableCell padding="checkbox">
                                                    <Checkbox
                                                        checked={
                                                            ...
                                                            selectedExclusionIds.size === exclusionRules.length
                                                        }
                                                        indeterminate={
                                                        ...
                                                        slotProps={{
                                                            input: { 'aria-label': 'Select all exclusion rules' },
                                                        }}
                                                    />
                                                </TableCell>
                                            ...
                                            {exclusionRules.map((rule) => {
                                                ...
                                                return (
                                                    <TableRow
                                                        key={rule.id}
                                                        hover
                                                        selected={selectedExclusionIds.has(rule.id)}
                                                    >
                                                        <TableCell padding="checkbox">
                                                            <Checkbox
                                                            ...
                                                            <>
                                                                <TableCell>
                                                                    <FormControl size="small" sx={{ minWidth: 120 }}>
                                                                        <Select
                                                                            value={editExclusionPayer}
                                                                            onChange={(e) =>
                                                                                setEditExclusionPayer(e.target.value)
                                                                            }
                                                                        >
                                                                            <MenuItem value="Brian">Brian</MenuItem>
                                                                            <MenuItem value="Patrice">Patrice</MenuItem>
                                                                            {editExclusionPayer !== 'Brian' &&
                                                                            editExclusionPayer !== 'Patrice' ? (
                                                                                <MenuItem value={editExclusionPayer}>
                                                                                    {editExclusionPayer}
                                                                                </MenuItem>
                                                                            ) : null}
                                                                        </Select>
                                                                ...
                                                                <TableCell>
                                                                    <TextField
                                                                        ...
                                                                        onChange={(e) =>
                                                                            setEditExclusionPattern(e.target.value)
                                                                        }
                                                                    />
                                                                </TableCell>
                                                                <TableCell align="right">
                                                                    <Tooltip title="Save">
                                                                        <IconButton
                                                                            size="small"
                                                                            onClick={() =>
                                                                                void saveEditExclusionRule(rule.id)
                                                                            }
                                                                    ...
                                                                    <Tooltip title="Cancel">
                                                                        <IconButton
                                                                            size="small"
                                                                            onClick={cancelEditExclusionRule}
                                                            ...
                                                            <>
                                                                ...
                                                                <TableCell align="right">
                                                                    ...
                                                                    <IconButton
                                                                        size="small"
                                                                        onClick={() =>
                                                                            void handleDeleteExclusionRule(rule.id)
                                                                        }
                ...
                <Paper sx={{ p: 3 }}>
                    <Stack spacing={2}>
                        ...
                        <Typography color="text.secondary">
                            Transactions whose description contains one of these substrings (case-insensitive) are
                            tagged "Variably" instead of the default "Equally" split.
                        </Typography>
                        <Stack direction="row" spacing={2} sx={{ alignItems: 'center' }}>
                            <TextField
                                label="Pattern"
                                        ...
                                        <TableHead>
                                            <TableRow>
                                                <TableCell padding="checkbox">
                                                    <Checkbox
                                                        checked={
                                                            variableRules.length > 0 &&
                                                            selectedVariableIds.size === variableRules.length
                                                        }
                                                        indeterminate={
                                                        ...
                                                        slotProps={{
                                                            input: { 'aria-label': 'Select all variable-split rules' },
                                                        }}
                                                    />
                                                </TableCell>
                                                <TableCell>Pattern</TableCell>
                                            ...
                                            {variableRules.map((rule) => {
                                                ...
                                                return (
                                                    <TableRow
                                                        key={rule.id}
                                                        hover
                                                        selected={selectedVariableIds.has(rule.id)}
                                                    >
                                                        <TableCell padding="checkbox">
                                                            <Checkbox
                                                        ...
                                                        {isEditing ? (
                                                            <>
                                                                <TableCell>
                                                                    <TextField
                                                                        ...
                                                                        onChange={(e) =>
                                                                            setEditVariablePattern(e.target.value)
                                                                        }
                                                                    />
                                                                </TableCell>
                                                                <TableCell align="right">
                                                                    <Tooltip title="Save">
                                                                        <IconButton
                                                                            size="small"
                                                                            onClick={() =>
                                                                                void saveEditVariableRule(rule.id)
                                                                            }
                                                                            aria-label="Save rule"
                                                                        >
                                                                            <CheckIcon fontSize="small" />
                                                                    ...
                                                                    <Tooltip title="Cancel">
                                                                        <IconButton
                                                                            size="small"
                                                                            onClick={cancelEditVariableRule}
                                                                            aria-label="Cancel edit"
                                                                        >
                                                                            <CloseIcon fontSize="small" />
                                                                        </IconButton>
                                                            ...
                                                            <>
                                                                ...
                                                                <TableCell align="right">
                                                                    <IconButton
                                                                        size="small"
                                                                        onClick={() => startEditVariableRule(rule)}
                                                                        aria-label="Edit rule"
                                                                    >
                                                                        <EditIcon fontSize="small" />
                                                                    </IconButton>
                                                                    <IconButton
                                                                        size="small"
                                                                        onClick={() =>
                                                                            void handleDeleteVariableRule(rule.id)
                                                                        }
                                                                        aria-label="Delete rule"
                                                                    >
                                                                        <DeleteIcon fontSize="small" />
